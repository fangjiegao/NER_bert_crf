...
def main(_):
  ...
  processors = {
      "cola": ner_crf.ColaProcessor,
      "mnli": ner_crf.MnliProcessor,
      "mrpc": ner_crf.MrpcProcessor,
  }
  ...
  if FLAGS.do_train:
    train_features = ner_crf.convert_examples_to_features(
        train_examples, label_list, FLAGS.max_seq_length, tokenizer)
    tf.logging.info("***** Running training *****")
    tf.logging.info("  Num examples = %d", len(train_examples))
    tf.logging.info("  Batch size = %d", FLAGS.train_batch_size)
    tf.logging.info("  Num steps = %d", num_train_steps)
    train_input_fn = ner_crf.input_fn_builder(
  ...
  if FLAGS.do_eval:
    ...
    eval_features = ner_crf.convert_examples_to_features(
    ...
    eval_input_fn = ner_crf.input_fn_builder(
